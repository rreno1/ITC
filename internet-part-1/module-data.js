  ...
  lessons: [
    {
      ...
      definitions: [
        { term: 'Sender', definition: 'The device or application that originates the information being sent.' },
        { term: 'Receiver', definition: 'The target device or application intended to receive the information.' },
        { term: 'Transmission Medium', definition: 'The physical or wireless path (copper, fiber, radio waves) over which data travels.' },
        { term: 'Protocol Rules', definition: 'Agreed standards governing how data is formatted, sent, and acknowledged.' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Physical Signal', definition: 'A detectable physical quantity (electrical voltage, light pulse, or radio wave) representing binary data.' },
        { term: 'Copper Transmission', definition: 'Carrying binary data using varying electrical voltages over copper wires.' },
        { term: 'Fiber-Optic Transmission', definition: 'Carrying binary data as rapid pulses of light down ultra-pure glass strands.' },
        { term: 'Wireless Modulation', definition: 'Varying the frequency, amplitude, or phase of radio waves to encode binary 1s and 0s.' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Computer Network', definition: 'A group of connected devices capable of communicating and sharing resources.' },
        { term: 'Node', definition: 'Any active electronic device connected to a network that can send, receive, or forward data.' },
        { term: 'Host', definition: 'An end-user device (like a laptop or server) assigned a network address that originates or consumes data.' },
        { term: 'Resource', definition: 'Hardware, files, applications, or data shared across a network.' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Local Network (LAN)', definition: 'A private network operating within a limited area under single organizational control.' },
        { term: 'The Internet', definition: 'The global system of interconnected independent networks communicating via TCP/IP.' },
        { term: 'Network Independence', definition: 'The ability of a local network to share local files and devices without outside connectivity.' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'PAN', definition: 'Personal Area Network (around 1 person, e.g. Bluetooth mouse or earbuds).' },
        { term: 'LAN & WLAN', definition: 'Local Area Network and Wireless LAN (a room, home, lab, or single building).' },
        { term: 'CAN', definition: 'Campus Area Network (connecting multiple nearby organizational buildings).' },
        { term: 'MAN & WAN', definition: 'Metropolitan Area Network (city-wide) and Wide Area Network (provinces, countries, global).' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Coverage', definition: 'How far the physical or wireless network spans geographically (PAN, LAN, WAN).' },
        { term: 'Medium', definition: 'Whether signals travel through physical cables (wired), radio waves (wireless), or both (hybrid).' },
        { term: 'Architecture', definition: 'How control and resource sharing are structured (Peer-to-Peer vs Client-Server).' },
        { term: 'Access & Topology', definition: 'Who is allowed to enter (Intranet/Extranet/Public) and how nodes are wired (Star/Mesh).' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Ethernet Cable', definition: 'Shielded or unshielded twisted-pair copper cabling using modular RJ45 connectors.' },
        { term: 'Wi-Fi (IEEE 802.11)', definition: 'Wireless local networking technology operating over 2.4 GHz, 5 GHz, or 6 GHz radio bands.' },
        { term: 'Interference', definition: 'Distortion of wireless radio signals caused by obstacles, distance, or competing electronic devices.' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Peer-to-Peer (P2P)', definition: 'A decentralized network architecture where every node can act as both client and server.' },
        { term: 'Client', definition: 'A user device or application (e.g. web browser) that requests services or files.' },
        { term: 'Server', definition: 'A high-capacity computer or service that listens for, processes, and fulfills client requests.' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Intranet', definition: 'A private network accessible only to an internal staff or members.' },
        { term: 'Extranet', definition: 'A secure extension of an intranet providing restricted access to trusted external entities.' },
        { term: 'Public Internet', definition: 'The globally accessible network open to the public.' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Star Topology', definition: 'All network nodes connect independently to a single central device (switch or AP).' },
        { term: 'Bus Topology', definition: 'Legacy arrangement where nodes share a single central trunk cable with terminators.' },
        { term: 'Ring Topology', definition: 'Nodes connect sequentially in a continuous loop, passing tokens in one direction.' },
        { term: 'Mesh Topology', definition: 'Redundant interconnections between nodes providing multiple path options.' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Copper Cat6', definition: 'Standard Ethernet cabling carrying up to 10 Gbps signals up to 55-100 meters.' },
        { term: 'Single-Mode Fiber', definition: 'Fiber-optic cable using narrow laser light beams for multi-kilometer transmission.' },
        { term: 'Electromagnetic Interference (EMI)', definition: 'Distortion of electrical signals caused by heavy machinery, power lines, or lightning.' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'NIC', definition: 'Network Interface Card: the hardware component giving a device a physical connection and MAC address.' },
        { term: 'Switch', definition: 'A local device that forwards frames between devices on the same local network.' },
        { term: 'Router', definition: 'A gateway device that forwards packets between different networks based on IP addresses.' },
        { term: 'Modem / ONT', definition: 'A device that translates ISP access signals (fiber/copper/cable) into local network traffic.' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Aggregation', definition: 'Combining traffic from multiple local end-user devices into central network paths.' },
        { term: 'Integrated Gateway', definition: 'A single consumer box combining router, switch, access point, and modem functions.' },
        { term: 'Enterprise Layout', definition: 'A network separating switches, firewalls, routers, and access points into dedicated hardware.' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'MAC Address', definition: 'A unique 48-bit physical identifier (e.g. 00:1A:2B:3C:4D:5E) assigned to a network interface card.' },
        { term: 'Local Switching', definition: 'Direct forwarding of frames between local ports without sending data outside the local network.' },
        { term: 'Frame', definition: 'A unit of data formatted for local delivery across a physical link using MAC addresses.' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Layered Architecture', definition: 'Dividing networking functions into distinct levels so software and hardware can be designed independently.' },
        { term: 'Application Layer', definition: 'The top layer containing user-facing network applications and protocols.' },
        { term: 'Link & Physical Layers', definition: 'The bottom layers responsible for local MAC delivery and physical signal transmission.' }
      ],
      examples: [
