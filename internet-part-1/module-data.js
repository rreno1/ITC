  ...
  lessons: [
    {
      ...
      definitions: [
        { term: 'Sender', definition: 'The device or application that originates the information being sent.', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=1' },
        { term: 'Receiver', definition: 'The target device or application intended to receive the information.', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=2' },
        { term: 'Transmission Medium', definition: 'The physical or wireless path (copper, fiber, radio waves) over which data travels.', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=3' },
        { term: 'Protocol Rules', definition: 'Agreed standards governing how data is formatted, sent, and acknowledged.', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=4' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Physical Signal', definition: 'A detectable physical quantity (electrical voltage, light pulse, or radio wave) representing binary data.', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=5' },
        { term: 'Copper Transmission', definition: 'Carrying binary data using varying electrical voltages over copper wires.', image: 'https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?w=800&auto=format&fit=crop&term=6' },
        { term: 'Fiber-Optic Transmission', definition: 'Carrying binary data as rapid pulses of light down ultra-pure glass strands.', image: 'https://images.unsplash.com/photo-1551703599-6b3e8379aa8c?w=800&auto=format&fit=crop&term=7' },
        { term: 'Wireless Modulation', definition: 'Varying the frequency, amplitude, or phase of radio waves to encode binary 1s and 0s.', image: 'https://images.unsplash.com/photo-1563770660941-20978e870e26?w=800&auto=format&fit=crop&term=8' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Computer Network', definition: 'A group of connected devices capable of communicating and sharing resources.', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=9' },
        { term: 'Node', definition: 'Any active electronic device connected to a network that can send, receive, or forward data.', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=10' },
        { term: 'Host', definition: 'An end-user device (like a laptop or server) assigned a network address that originates or consumes data.', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=11' },
        { term: 'Resource', definition: 'Hardware, files, applications, or data shared across a network.', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=12' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Local Network (LAN)', definition: 'A private network operating within a limited area under single organizational control.', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=13' },
        { term: 'The Internet', definition: 'The global system of interconnected independent networks communicating via TCP/IP.', image: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&auto=format&fit=crop&term=14' },
        { term: 'Network Independence', definition: 'The ability of a local network to share local files and devices without outside connectivity.', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=15' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'PAN', definition: 'Personal Area Network (around 1 person, e.g. Bluetooth mouse or earbuds).', image: 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=800&auto=format&fit=crop&term=16' },
        { term: 'LAN & WLAN', definition: 'Local Area Network and Wireless LAN (a room, home, lab, or single building).', image: 'https://images.unsplash.com/photo-1563770660941-20978e870e26?w=800&auto=format&fit=crop&term=17' },
        { term: 'CAN', definition: 'Campus Area Network (connecting multiple nearby organizational buildings).', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=18' },
        { term: 'MAN & WAN', definition: 'Metropolitan Area Network (city-wide) and Wide Area Network (provinces, countries, global).', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=19' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Coverage', definition: 'How far the physical or wireless network spans geographically (PAN, LAN, WAN).', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=20' },
        { term: 'Medium', definition: 'Whether signals travel through physical cables (wired), radio waves (wireless), or both (hybrid).', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=21' },
        { term: 'Architecture', definition: 'How control and resource sharing are structured (Peer-to-Peer vs Client-Server).', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=22' },
        { term: 'Access & Topology', definition: 'Who is allowed to enter (Intranet/Extranet/Public) and how nodes are wired (Star/Mesh).', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=23' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Ethernet Cable', definition: 'Shielded or unshielded twisted-pair copper cabling using modular RJ45 connectors.', image: 'https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?w=800&auto=format&fit=crop&term=24' },
        { term: 'Wi-Fi (IEEE 802.11)', definition: 'Wireless local networking technology operating over 2.4 GHz, 5 GHz, or 6 GHz radio bands.', image: 'https://images.unsplash.com/photo-1563770660941-20978e870e26?w=800&auto=format&fit=crop&term=25' },
        { term: 'Interference', definition: 'Distortion of wireless radio signals caused by obstacles, distance, or competing electronic devices.', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=26' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Peer-to-Peer (P2P)', definition: 'A decentralized network architecture where every node can act as both client and server.', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=27' },
        { term: 'Client', definition: 'A user device or application (e.g. web browser) that requests services or files.', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=28' },
        { term: 'Server', definition: 'A high-capacity computer or service that listens for, processes, and fulfills client requests.', image: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=800&auto=format&fit=crop&term=29' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        ...
        { term: 'Extranet', definition: 'A secure extension of an intranet providing restricted access to trusted external entities.', image: 'https://images.unsplash.com/photo-1563986768609-322da13575f3?w=800&auto=format&fit=crop&term=30' },
        { term: 'Public Internet', definition: 'The globally accessible network open to the public.', image: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&auto=format&fit=crop&term=31' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Star Topology', definition: 'All network nodes connect independently to a single central device (switch or AP).', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=32' },
        { term: 'Bus Topology', definition: 'Legacy arrangement where nodes share a single central trunk cable with terminators.', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=33' },
        { term: 'Ring Topology', definition: 'Nodes connect sequentially in a continuous loop, passing tokens in one direction.', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=34' },
        { term: 'Mesh Topology', definition: 'Redundant interconnections between nodes providing multiple path options.', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=35' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Copper Cat6', definition: 'Standard Ethernet cabling carrying up to 10 Gbps signals up to 55-100 meters.', image: 'https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?w=800&auto=format&fit=crop&term=36' },
        { term: 'Single-Mode Fiber', definition: 'Fiber-optic cable using narrow laser light beams for multi-kilometer transmission.', image: 'https://images.unsplash.com/photo-1551703599-6b3e8379aa8c?w=800&auto=format&fit=crop&term=37' },
        { term: 'Electromagnetic Interference (EMI)', definition: 'Distortion of electrical signals caused by heavy machinery, power lines, or lightning.', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=38' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'NIC', definition: 'Network Interface Card: the hardware component giving a device a physical connection and MAC address.', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=39' },
        { term: 'Switch', definition: 'A local device that forwards frames between devices on the same local network.', image: 'https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=800&auto=format&fit=crop&term=40' },
        { term: 'Router', definition: 'A gateway device that forwards packets between different networks based on IP addresses.', image: 'https://images.unsplash.com/photo-1563770660941-20978e870e26?w=800&auto=format&fit=crop&term=41' },
        { term: 'Modem / ONT', definition: 'A device that translates ISP access signals (fiber/copper/cable) into local network traffic.', image: 'https://images.unsplash.com/photo-1563770660941-20978e870e26?w=800&auto=format&fit=crop&term=42' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Aggregation', definition: 'Combining traffic from multiple local end-user devices into central network paths.', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=43' },
        { term: 'Integrated Gateway', definition: 'A single consumer box combining router, switch, access point, and modem functions.', image: 'https://images.unsplash.com/photo-1563770660941-20978e870e26?w=800&auto=format&fit=crop&term=44' },
        { term: 'Enterprise Layout', definition: 'A network separating switches, firewalls, routers, and access points into dedicated hardware.', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=45' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'MAC Address', definition: 'A unique 48-bit physical identifier (e.g. 00:1A:2B:3C:4D:5E) assigned to a network interface card.', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=46' },
        { term: 'Local Switching', definition: 'Direct forwarding of frames between local ports without sending data outside the local network.', image: 'https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=800&auto=format&fit=crop&term=47' },
        { term: 'Frame', definition: 'A unit of data formatted for local delivery across a physical link using MAC addresses.', image: 'https://images.unsplash.com/photo-1508739773434-c26b3d09e071?w=800&auto=format&fit=crop&term=48' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Layered Architecture', definition: 'Dividing networking functions into distinct levels so software and hardware can be designed independently.', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=49' },
        { term: 'Application Layer', definition: 'The top layer containing user-facing network applications and protocols.', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=50' },
        { term: 'Link & Physical Layers', definition: 'The bottom layers responsible for local MAC delivery and physical signal transmission.', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&term=51' }
      ],
      examples: [
