  ...
  lessons: [
    {
      ...
      definitions: [
        { term: 'Sender', definition: 'The device or application that originates the information being sent.', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=1280&auto=format&fit=crop&tech=16' },
        { term: 'Receiver', definition: 'The target device or application intended to receive the information.', image: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=1280&auto=format&fit=crop&tech=17' },
        { term: 'Transmission Medium', definition: 'The physical or wireless path (copper, fiber, radio waves) over which data travels.', image: 'https://images.unsplash.com/photo-1542751371-adc38448a05e?w=1280&auto=format&fit=crop&tech=18' },
        { term: 'Protocol Rules', definition: 'Agreed standards governing how data is formatted, sent, and acknowledged.', image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1280&auto=format&fit=crop&tech=19' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Physical Signal', definition: 'A detectable physical quantity (electrical voltage, light pulse, or radio wave) representing binary data.', image: 'https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?w=1280&auto=format&fit=crop&tech=20' },
        { term: 'Copper Transmission', definition: 'Carrying binary data using varying electrical voltages over copper wires.', image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1280&auto=format&fit=crop&tech=21' },
        { term: 'Fiber-Optic Transmission', definition: 'Carrying binary data as rapid pulses of light down ultra-pure glass strands.', image: 'https://images.unsplash.com/photo-1526374870839-e155464bb9b2?w=1280&auto=format&fit=crop&tech=22' },
        { term: 'Wireless Modulation', definition: 'Varying the frequency, amplitude, or phase of radio waves to encode binary 1s and 0s.', image: 'https://images.unsplash.com/photo-1510511459019-5dda7724fd87?w=1280&auto=format&fit=crop&tech=23' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Computer Network', definition: 'A group of connected devices capable of communicating and sharing resources.', image: 'https://images.unsplash.com/photo-1531297484001-80022131f5a1?w=1280&auto=format&fit=crop&tech=24' },
        { term: 'Node', definition: 'Any active electronic device connected to a network that can send, receive, or forward data.', image: 'https://images.unsplash.com/photo-1534972195531-d756b9bfa9f2?w=1280&auto=format&fit=crop&tech=25' },
        { term: 'Host', definition: 'An end-user device (like a laptop or server) assigned a network address that originates or consumes data.', image: 'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=1280&auto=format&fit=crop&tech=26' },
        { term: 'Resource', definition: 'Hardware, files, applications, or data shared across a network.', image: 'https://images.unsplash.com/photo-1504639725590-34d0984388bd?w=1280&auto=format&fit=crop&tech=27' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Local Network (LAN)', definition: 'A private network operating within a limited area under single organizational control.', image: 'https://images.unsplash.com/photo-1526379879527-8559ecfcaec0?w=1280&auto=format&fit=crop&tech=28' },
        { term: 'The Internet', definition: 'The global system of interconnected independent networks communicating via TCP/IP.', image: 'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=1280&auto=format&fit=crop&tech=29' },
        { term: 'Network Independence', definition: 'The ability of a local network to share local files and devices without outside connectivity.', image: 'https://images.unsplash.com/photo-1515879218367-8466d910aaa4?w=1280&auto=format&fit=crop&tech=30' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'PAN', definition: 'Personal Area Network (around 1 person, e.g. Bluetooth mouse or earbuds).', image: 'https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?w=1280&auto=format&fit=crop&tech=31' },
        { term: 'LAN & WLAN', definition: 'Local Area Network and Wireless LAN (a room, home, lab, or single building).', image: 'https://images.unsplash.com/photo-1531403009284-440f080d1e12?w=1280&auto=format&fit=crop&tech=32' },
        { term: 'CAN', definition: 'Campus Area Network (connecting multiple nearby organizational buildings).', image: 'https://images.unsplash.com/photo-1516321497487-e288fb19713f?w=1280&auto=format&fit=crop&tech=33' },
        { term: 'MAN & WAN', definition: 'Metropolitan Area Network (city-wide) and Wide Area Network (provinces, countries, global).', image: 'https://images.unsplash.com/photo-1535378917042-10a22c95931a?w=1280&auto=format&fit=crop&tech=34' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Coverage', definition: 'How far the physical or wireless network spans geographically (PAN, LAN, WAN).', image: 'https://images.unsplash.com/photo-1581092335397-9583fe92d232?w=1280&auto=format&fit=crop&tech=35' },
        { term: 'Medium', definition: 'Whether signals travel through physical cables (wired), radio waves (wireless), or both (hybrid).', image: 'https://images.unsplash.com/photo-1508739773434-c26b3d09e071?w=1280&auto=format&fit=crop&tech=36' },
        { term: 'Architecture', definition: 'How control and resource sharing are structured (Peer-to-Peer vs Client-Server).', image: 'https://images.unsplash.com/photo-1496065187959-7f07b8353c55?w=1280&auto=format&fit=crop&tech=37' },
        { term: 'Access & Topology', definition: 'Who is allowed to enter (Intranet/Extranet/Public) and how nodes are wired (Star/Mesh).', image: 'https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=1280&auto=format&fit=crop&tech=38' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Ethernet Cable', definition: 'Shielded or unshielded twisted-pair copper cabling using modular RJ45 connectors.', image: 'https://images.unsplash.com/photo-1551703599-6b3e8379aa8c?w=1280&auto=format&fit=crop&tech=39' },
        { term: 'Wi-Fi (IEEE 802.11)', definition: 'Wireless local networking technology operating over 2.4 GHz, 5 GHz, or 6 GHz radio bands.', image: 'https://images.unsplash.com/photo-1563770660941-20978e870e26?w=1280&auto=format&fit=crop&tech=40' },
        { term: 'Interference', definition: 'Distortion of wireless radio signals caused by obstacles, distance, or competing electronic devices.', image: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=1280&auto=format&fit=crop&tech=41' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Peer-to-Peer (P2P)', definition: 'A decentralized network architecture where every node can act as both client and server.', image: 'https://images.unsplash.com/photo-1563986768609-322da13575f3?w=1280&auto=format&fit=crop&tech=42' },
        { term: 'Client', definition: 'A user device or application (e.g. web browser) that requests services or files.', image: 'https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=1280&auto=format&fit=crop&tech=43' },
        { term: 'Server', definition: 'A high-capacity computer or service that listens for, processes, and fulfills client requests.', image: 'https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=1280&auto=format&fit=crop&tech=44' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        ...
        { term: 'Extranet', definition: 'A secure extension of an intranet providing restricted access to trusted external entities.', image: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=1280&auto=format&fit=crop&tech=45' },
        { term: 'Public Internet', definition: 'The globally accessible network open to the public.', image: 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=1280&auto=format&fit=crop&tech=46' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Star Topology', definition: 'All network nodes connect independently to a single central device (switch or AP).', image: 'https://images.unsplash.com/photo-1520869578617-557561d7b114?w=1280&auto=format&fit=crop&tech=47' },
        { term: 'Bus Topology', definition: 'Legacy arrangement where nodes share a single central trunk cable with terminators.', image: 'https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=1280&auto=format&fit=crop&tech=48' },
        { term: 'Ring Topology', definition: 'Nodes connect sequentially in a continuous loop, passing tokens in one direction.', image: 'https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?w=1280&auto=format&fit=crop&tech=49' },
        { term: 'Mesh Topology', definition: 'Redundant interconnections between nodes providing multiple path options.', image: 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=1280&auto=format&fit=crop&tech=50' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Copper Cat6', definition: 'Standard Ethernet cabling carrying up to 10 Gbps signals up to 55-100 meters.', image: 'https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=1280&auto=format&fit=crop&tech=51' },
        { term: 'Single-Mode Fiber', definition: 'Fiber-optic cable using narrow laser light beams for multi-kilometer transmission.', image: 'https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=1280&auto=format&fit=crop&tech=52' },
        { term: 'Electromagnetic Interference (EMI)', definition: 'Distortion of electrical signals caused by heavy machinery, power lines, or lightning.', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=1280&auto=format&fit=crop&tech=53' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'NIC', definition: 'Network Interface Card: the hardware component giving a device a physical connection and MAC address.', image: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=1280&auto=format&fit=crop&tech=54' },
        { term: 'Switch', definition: 'A local device that forwards frames between devices on the same local network.', image: 'https://images.unsplash.com/photo-1542751371-adc38448a05e?w=1280&auto=format&fit=crop&tech=55' },
        { term: 'Router', definition: 'A gateway device that forwards packets between different networks based on IP addresses.', image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1280&auto=format&fit=crop&tech=56' },
        { term: 'Modem / ONT', definition: 'A device that translates ISP access signals (fiber/copper/cable) into local network traffic.', image: 'https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?w=1280&auto=format&fit=crop&tech=57' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Aggregation', definition: 'Combining traffic from multiple local end-user devices into central network paths.', image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1280&auto=format&fit=crop&tech=58' },
        { term: 'Integrated Gateway', definition: 'A single consumer box combining router, switch, access point, and modem functions.', image: 'https://images.unsplash.com/photo-1526374870839-e155464bb9b2?w=1280&auto=format&fit=crop&tech=59' },
        { term: 'Enterprise Layout', definition: 'A network separating switches, firewalls, routers, and access points into dedicated hardware.', image: 'https://images.unsplash.com/photo-1510511459019-5dda7724fd87?w=1280&auto=format&fit=crop&tech=60' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'MAC Address', definition: 'A unique 48-bit physical identifier (e.g. 00:1A:2B:3C:4D:5E) assigned to a network interface card.', image: 'https://images.unsplash.com/photo-1531297484001-80022131f5a1?w=1280&auto=format&fit=crop&tech=61' },
        { term: 'Local Switching', definition: 'Direct forwarding of frames between local ports without sending data outside the local network.', image: 'https://images.unsplash.com/photo-1534972195531-d756b9bfa9f2?w=1280&auto=format&fit=crop&tech=62' },
        { term: 'Frame', definition: 'A unit of data formatted for local delivery across a physical link using MAC addresses.', image: 'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=1280&auto=format&fit=crop&tech=63' }
      ],
      examples: [
    ...
    },
    {
      ...
      definitions: [
        { term: 'Layered Architecture', definition: 'Dividing networking functions into distinct levels so software and hardware can be designed independently.', image: 'https://images.unsplash.com/photo-1504639725590-34d0984388bd?w=1280&auto=format&fit=crop&tech=64' },
        { term: 'Application Layer', definition: 'The top layer containing user-facing network applications and protocols.', image: 'https://images.unsplash.com/photo-1526379879527-8559ecfcaec0?w=1280&auto=format&fit=crop&tech=65' },
        { term: 'Link & Physical Layers', definition: 'The bottom layers responsible for local MAC delivery and physical signal transmission.', image: 'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=1280&auto=format&fit=crop&tech=66' }
      ],
      examples: [
